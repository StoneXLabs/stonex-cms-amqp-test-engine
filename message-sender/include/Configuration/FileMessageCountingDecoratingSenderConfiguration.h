...
{
public:
	FileMessageCountingDecoratingSenderConfiguration(const std::string& connectionId, const std::string& sessionId, const std::string& producerId, const std::string& messageType, const std::string& senderType, const std::string& file_path, long long message_count, const std::vector<MessageField*>& decorations);
