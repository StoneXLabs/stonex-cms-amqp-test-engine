...
CMSClientTestUnit::CMSClientTestUnit(const WrapperConfiguration & config, std::shared_ptr<StonexLogger> logger, const std::string userIdentifier, cms::ExceptionListener* factoryExceptionListener, cms::ExceptionListener* connectionExceptionListener, cms::ExceptionListener* sessionExceptionListener)
{
